...
export const GtfsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} [startTimeFrom]   Filter by start time from. Only return items which have date/time after or equals to given value. Format: \&quot;YYYY-MM-DDTHH:MM:SS+Z\&quot;, e.g. \&quot;2021-11-03T55:48:49+02:00\&quot;. Note that all date/times must have a timezone specification.
         * @param {string} [startTimeTo]   Filter by start time to. Only return items which have date/time before or equals to given value. Format: \&quot;YYYY-MM-DDTHH:MM:SS+Z\&quot;, e.g. \&quot;2021-11-03T55:48:49+02:00\&quot;. Note that all date/times must have a timezone specification.
...
export const SiriApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} [siriVehicleLocationRecordedAtTimeFrom]   Filter by siri vehicle location recorded at time. Only return items which have date/time after or equals to given value. Format: \&quot;YYYY-MM-DDTHH:MM:SS+Z\&quot;, e.g. \&quot;2021-11-03T55:48:49+02:00\&quot;. Note that all date/times must have a timezone specification.
         * @param {string} [siriVehicleLocationRecordedAtTimeTo]   Filter by siri vehicle location recorded at time. Only return items which have date/time before or equals to given value. Format: \&quot;YYYY-MM-DDTHH:MM:SS+Z\&quot;, e.g. \&quot;2021-11-03T55:48:49+02:00\&quot;. Note that all date/times must have a timezone specification.
         * @param {string} [siriRideScheduledStartTimeFrom]   Filter by siri ride scheduled start time. Only return items which have date/time after or equals to given value. Format: \&quot;YYYY-MM-DDTHH:MM:SS+Z\&quot;, e.g. \&quot;2021-11-03T55:48:49+02:00\&quot;. Note that all date/times must have a timezone specification.
         * @param {string} [siriRideScheduledStartTimeTo]   Filter by siri ride scheduled start time. Only return items which have date/time before or equals to given value. Format: \&quot;YYYY-MM-DDTHH:MM:SS+Z\&quot;, e.g. \&quot;2021-11-03T55:48:49+02:00\&quot;. Note that all date/times must have a timezone specification.
         ...
         * @param {string} [gtfsRideStartTimeFrom]   Filter by related gtfs ride\&#39;s start time from. Only return items which have date/time after or equals to given value. Format: \&quot;YYYY-MM-DDTHH:MM:SS+Z\&quot;, e.g. \&quot;2021-11-03T55:48:49+02:00\&quot;. Note that all date/times must have a timezone specification.
         * @param {string} [gtfsRideStartTimeTo]   Filter by related gtfs ride\&#39;s start time to. Only return items which have date/time before or equals to given value. Format: \&quot;YYYY-MM-DDTHH:MM:SS+Z\&quot;, e.g. \&quot;2021-11-03T55:48:49+02:00\&quot;. Note that all date/times must have a timezone specification.
         ...
         * @param {string} [scheduledStartTimeFrom]   Filter by scheduled start time. Only return items which have date/time after or equals to given value. Format: \&quot;YYYY-MM-DDTHH:MM:SS+Z\&quot;, e.g. \&quot;2021-11-03T55:48:49+02:00\&quot;. Note that all date/times must have a timezone specification.
         * @param {string} [scheduledStartTimeTo]   Filter by scheduled start time. Only return items which have date/time before or equals to given value. Format: \&quot;YYYY-MM-DDTHH:MM:SS+Z\&quot;, e.g. \&quot;2021-11-03T55:48:49+02:00\&quot;. Note that all date/times must have a timezone specification.
         * @param {string} [orderBy] Order of the results. Comma-separated list of fields and direction. e.g. \&quot;field1 asc,field2 desc\&quot;.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
         ...
         * @param {string} [recordedAtTimeFrom]   Filter by recorded at time. Only return items which have date/time after or equals to given value. Format: \&quot;YYYY-MM-DDTHH:MM:SS+Z\&quot;, e.g. \&quot;2021-11-03T55:48:49+02:00\&quot;. Note that all date/times must have a timezone specification.
         * @param {string} [recordedAtTimeTo]   Filter by recorded at time. Only return items which have date/time before or equals to given value. Format: \&quot;YYYY-MM-DDTHH:MM:SS+Z\&quot;, e.g. \&quot;2021-11-03T55:48:49+02:00\&quot;. Note that all date/times must have a timezone specification.
         ...
         * @param {string} [siriRidesSchedualedStartTimeFrom]   Filter by siri ride scheduled start time. Only return items which have date/time after or equals to given value. Format: \&quot;YYYY-MM-DDTHH:MM:SS+Z\&quot;, e.g. \&quot;2021-11-03T55:48:49+02:00\&quot;. Note that all date/times must have a timezone specification.
         * @param {string} [siriRidesSchedualedStartTimeTo]   Filter by siri ride scheduled start time. Only return items which have date/time before or equals to given value. Format: \&quot;YYYY-MM-DDTHH:MM:SS+Z\&quot;, e.g. \&quot;2021-11-03T55:48:49+02:00\&quot;. Note that all date/times must have a timezone specification.
...
export const UserCasesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {number} [offset] Item number to start returning results from. Use in combination with limit for pagination, alternatively, don\&#39;t set offset, set limit to -1 and use http streaming with compatible json streaming decoder to get all results up to a maximum of 500000 results.
         * @param {boolean} [getCount] Set to \&quot;true\&quot; to only get the total number of results for given filters. limit/offset/order parameters will be ignored.
         * @param {string} [plannedStartTimeDateFrom] Set a time range to get the timetable of a specific ride  Filter by planned_start_time. Only return items which have date/time after or equals to given value. Format: \&quot;YYYY-MM-DDTHH:MM:SS+Z\&quot;, e.g. \&quot;2021-11-03T55:48:49+02:00\&quot;. Note that all date/times must have a timezone specification.
         * @param {string} [plannedStartTimeDateTo] Set a time range to get the time table of a specific ride  Filter by planned_start_time. Only return items which have date/time before or equals to given value. Format: \&quot;YYYY-MM-DDTHH:MM:SS+Z\&quot;, e.g. \&quot;2021-11-03T55:48:49+02:00\&quot;. Note that all date/times must have a timezone specification.
